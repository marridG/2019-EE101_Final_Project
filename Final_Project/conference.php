		...
		// Row One
			// Previous Page
				...
				if($i>=1)
				{
					...
					echo "</td><td>";
					echo "<a  href=\"/EE101-Final_Project/Final_Project/conference.php?conference_name=$conference_name_temp&page=$i#skip_conference\"><img src =\"/EE101-Final_Project/Final_Project/pics/Turn_Page_prev.png\" id=\"search__Turn_Page_prev_page\"></a>";
			...
			// Pages in the middle
				for($i=$min_page;$i<=$max_page;$i++)
				{
					if($i==$page)
						...
						echo "<td><a href=\"/EE101-Final_Project/Final_Project/conference.php?conference_name=$conference_name_temp&page=$i#skip_conference\"><img src =\"/EE101-Final_Project/Final_Project/pics/Turn_Page_not_selected.png\"  id=\"search__Turn_Page_not_selected\"></a></td>";
				}
			// Next Page
				echo "<td>";
				$i=$page+1;
				...
				{
					echo "<a href=\"/EE101-Final_Project/Final_Project/conference.php?conference_name=$conference_name_temp&page=$i#skip_conference\" id=\"search__Turn_Page_prev_page\"><img src =\"/EE101-Final_Project/Final_Project/pics/Turn_Page_next.png\" id=\"search__Turn_Page_next_page\"></a>";
					echo "</td><td>";
					echo "<a href=\"/EE101-Final_Project/Final_Project/conference.php?conference_name=$conference_name_temp&page=$i#skip_conference\" id=\"search__Turn_Page_prev_page\"><img src =\"/EE101-Final_Project/Final_Project/pics/Turn_Page_empty.jpg\" id=\"search__Turn_Page_empty\"></a>";
				}
				else
				{
			...
			// Show Page Numbers
				...
				{ 
					...
					if($i==$page)
						...
						echo "<a class=\"output_href\" id=\"number\" href=\"/EE101-Final_Project/Final_Project/conference.php?conference_name=$conference_name_temp&page=$i#skip_conference\">$i</a>";
					echo "</td>";
				}
